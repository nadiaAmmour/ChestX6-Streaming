error id: jar:file:///C:/Users/nadia/AppData/Local/Coursier/cache/v1/https/repo1.maven.org/maven2/org/apache/hadoop/hadoop-client-api/3.3.2/hadoop-client-api-3.3.2-sources.jar!/org/apache/hadoop/fs/Path.java
jar:file:///C:/Users/nadia/AppData/Local/Coursier/cache/v1/https/repo1.maven.org/maven2/org/apache/hadoop/hadoop-client-api/3.3.2/hadoop-client-api-3.3.2-sources.jar!/org/apache/hadoop/fs/Path.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[497,17]

error in qdox parser
file content:
```java
offset: 16337
uri: jar:file:///C:/Users/nadia/AppData/Local/Coursier/cache/v1/https/repo1.maven.org/maven2/org/apache/hadoop/hadoop-client-api/3.3.2/hadoop-client-api-3.3.2-sources.jar!/org/apache/hadoop/fs/Path.java
text:
```scala
/**
...
public class Path
  ...
  public Path(Path parent, Path child) {
    // Add a slash to parent's path so resolution is org.apache.hadoop.shaded.com.atible with URI's
  ...
  public static Path mergePaths(Path path1, Path path2) {
    ...
    // Add path org.apache.hadoop.shaded.com.onents explicitly, because simply concatenating two path
   ...
   * @return the FileSystem that owns this Path
   * @throws java.org.apache.hadoop.shaded.io.IOException thrown if there's an issue resolving the
   * FileSystem
   */
  ...
  /**
   * Returns true if the path org.apache.hadoop.shaded.com.onent (i.e. directory) of this URI is
   ...
   * org.apache.hadoop.shaded.com.onents, borrow them from this URI
...
com.thoughtworks.qdox.parser.impl.Parser.yyerror(Parser.java:2025)
	...
	scala.meta.internal.pc.MetalsGlobal.symbolDocumentation(MetalsGlobal.scala:279)
	scala.meta.internal.pc.Signatures$SignaturePrinter.<init>(Signatures.scala:295)
	scala.meta.internal.pc.HoverProvider.toHover(HoverProvider.scala:274)
	scala.meta.internal.pc.HoverProvider.hoverOffset(HoverProvider.scala:109)
	...
	scala.meta.internal.pc.CompilerAccess.$anonfun$withNonInterruptableCompiler$1(CompilerAccess.scala:142)
	scala.meta.internal.pc.CompilerAccess.$anonfun$onCompilerJobQueue$1(CompilerAccess.scala:245)
...
QDox parse error in /org/apache/hadoop/fs/Path.java